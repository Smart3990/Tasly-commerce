                                                  ...
                                                  Builder(
                                                    builder: (context) {
                                                      if (valueOrDefault<bool>(
                                                        ...
                                                        return Text(
                                                          formatNumber(
                                                            (functions.sumCartPricesDIS(widget!
                                                                        .order!
                                                                        .products
                                                                        .toList()) -
                                                                    ((functions.sumCartPricesDIS(widget!.order!.products.toList()) *
                                                                            (_model
                                                                                .promoPercent!)) /
                                                                        100)) +
                                                                (functions.sumCartPricesDIS(widget!
                                                        ...
                                                        return Text(
                                                          formatNumber(
                                                            (functions.sumCartPrices(widget!
                                                                        .order!
                                                                        .products
                                                                        .toList()) -
                                                                    ((functions.sumCartPrices(widget!.order!.products.toList()) *
                                                                            (_model
                                                                                .promoPercent!)) /
                                                                        100)) +
                                                                (functions.sumCartPrices(widget!
