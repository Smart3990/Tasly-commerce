                                                              ...
                                                              children: [
                                                                if (containerUsersRecord
                                                                  ...
                                                                  FutureBuilder<
                                                                    ...
                                                                    future: ShippingAddressesRecord.getDocumentOnce(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return wrapWithModel(
                                                                        ...
                                                                        child:
                                                                            ShippingOrderWidget(
                                                                          title:
                                                                              shippingOrderShippingAddressesRecord.addressName,
                                                                          address:
                                                                              shippingOrderShippingAddressesRecord.address,
                                                                        ),
                                                                      );
                                                                    },
                                                                  ),
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return Builder(
                                                                      builder:
                                                                        ...
                                                                        if (containerUsersRecord
                                                                            .isDistributor) {
                                                                          return OrderItemdisWidget(
                                                                            key:
                                                                                Key('Key2d3_${productIndex}_of_${product.length}'),
                                                                            product:
                                                                                productItem,
                                                                            orderDocument:
                                                                                checkOutOrderRecord,
                                                                          ...
                                                                          return OrderItemWidget(
                                                                            key:
                                                                                Key('Keyn5i_${productIndex}_of_${product.length}'),
                                                                            product:
                                                                                productItem,
                                                                            orderDocument:
                                                                                checkOutOrderRecord,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        if (containerUsersRecord
                                                                          ...
                                                                          return Text(
                                                                            formatNumber(
                                                                              functions.sumCartPricesDIS(checkOutOrderRecord.products.toList()),
                                                                          ...
                                                                          return Text(
                                                                            formatNumber(
                                                                              functions.sumCartPrices(checkOutOrderRecord.products.toList()),
                                                                              formatType: FormatType.decimal,
                                                                              decimalType: DecimalType.automatic,
                                                                              currency: 'GHC ',
                                                                            ),
                                                                ...
                                                                Builder(
                                                                  builder:
                                                                    ...
                                                                    if (containerUsersRecord
                                                                      ...
                                                                      return Text(
                                                                        formatNumber(
                                                                          (functions.sumCartPricesDIS(checkOutOrderRecord.products.toList()) - ((functions.sumCartPricesDIS(checkOutOrderRecord.products.toList()) * (_model.promoPercent!)) / 100)) +
                                                                              (functions.sumCartPricesDIS(checkOutOrderRecord.products.toList()) * (_model.charges!)),
                                                                          formatType:
                                                                              FormatType.decimal,
                                                                          decimalType:
                                                                      ...
                                                                      return Text(
                                                                        formatNumber(
                                                                          (functions.sumCartPrices(checkOutOrderRecord.products.toList()) - ((functions.sumCartPrices(checkOutOrderRecord.products.toList()) * (_model.promoPercent!)) / 100)) +
                                                                              (functions.sumCartPrices(checkOutOrderRecord.products.toList()) * (_model.charges!)),
                                                                          formatType:
                                                                              FormatType.decimal,
                                                                          decimalType:
                                                                              DecimalType.automatic,
