              ...
              child: Stack(
                children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      if (widget!.product?.specialOfferRef !=
                                          null)
                                        Padding(
                                          padding:
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Padding(
                                          ...
                                          child: ReviewWidget(
                                            key: Key(
                                                'Key2bz_${listViewIndex}_of_${listViewReviewRecordList.length}'),
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 5.0, 30.0),
                      child: Container(
                        width: double.infinity,
                        height: 170.0,
                        decoration: BoxDecoration(
                                                                  ...
                                                                  if (valueOrDefault<
                                                                      ...
                                                                      valueOrDefault<
                                                                        ...
                                                                        formatNumber(
                                                                          valueOrDefault<double>(
                                                                                widget!.product?.productInformation?.distributorPrice,
                                                                                0.0,
                                                                              ) *
                                                                    ...
                                                                    return Text(
                                                                      valueOrDefault<
                                                                        ...
                                                                        formatNumber(
                                                                          valueOrDefault<double>(
                                                                                widget!.product?.productInformation?.price,
                                                                                0.0,
                                                                              ) *
                                                                              (_model.countControllerValue!),
                                                                          formatType:
