...
import '/components/product_component/product_search_item/product_search_item_widget.dart';
                                                            ...
                                                            () async {
                                                              if (_model.tfSearchTextController
                                                                ...
                                                                _model.searchResult = searchProductRecordList
                                                                    .where((e) =>
                                                                        ((_model.category == 'All') || ((_model.category != 'All') && (e.category == _model.category))) &&
                                                                        (e.productInformation.price >=
                                                                            _model
                                                                                .priceBiggerThan) &&
                                                                        (e.productInformation.rate >=
                                                                            _model
                                                                                .rateBiggerThan) &&
                                                                        (functions.textContaintext(e.productInformation.name, _model.tfSearchTextController.text) ||
                                                                            functions.textContaintext(e.productInformation.description,
                                            ...
                                            itemBuilder:
                                              ...
                                              return ProductSearchItemWidget(
                                                ...
                                                distributorPrice:
                                                  ...
                                                  productItem.productInformation
                                                      .distributorPrice,
                                                  0.0,
                                                ),
                                              );
