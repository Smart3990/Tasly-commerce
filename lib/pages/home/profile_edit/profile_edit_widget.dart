...
import '/components/other_component/avatar_with_update/avatar_with_update_widget.dart';
...
class _ProfileEditWidgetState extends State<ProfileEditWidget> {
  ...
  void initState() {
    ...
    _model.distributorIdTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.distributorId, ''));
    _model.distributorIdFocusNode ??= FocusNode();
                                ...
                                children: [
                                  ...
                                  if (valueOrDefault<bool>(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => TextFormField(
                                        controller:
                                            _model.distributorIdTextController,
                                        focusNode:
                                            _model.distributorIdFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelStyle:
                                        ...
                                        validator: _model
                                            .distributorIdTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  AuthUserStreamWidget(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          distributorId:
                              _model.distributorIdTextController.text,
                        ));
                        context.safePop();
                      },
