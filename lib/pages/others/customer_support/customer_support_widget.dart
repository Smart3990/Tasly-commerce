                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Expanded(
                                child:
                                    StreamBuilder<List<SupportMesagesRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    if (customerServiceColumnSupportMesagesRecordList
                                      ...
                                      return EmptyWidget(
                                        ...
                                        title: 'Chat Support!',
                                        body:
                                            'Start your ticket, We gald to help',
                                        customAction: () async {},
                                      );
                                    }
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Stack(
                                                                              children: [
                                                                                if (customerServiceColumnSupportMesagesRecord.video != null && customerServiceColumnSupportMesagesRecord.video != '')
                                                                                  Container(
                                                                                    width: double.infinity,
                                                                                    height: double.infinity,
                                                                                ...
                                                                                if (customerServiceColumnSupportMesagesRecord.audio != null && customerServiceColumnSupportMesagesRecord.audio != '')
                                                                                  Container(
                                                                                    width: double.infinity,
                                                                                    height: 80.0,
                                                                                    decoration: BoxDecoration(),
                                                                                ...
                                                                                if (customerServiceColumnSupportMesagesRecord.image != null && customerServiceColumnSupportMesagesRecord.image != '')
                                                                                  InkWell(
                                                                ...
                                                                SupportMesagesRecord
                                                                    .getDocumentFromData(
                                                                        createSupportMesagesRecordData(
                                                                          ...
                                                                          sender:
                                                                              currentUserReference,
                                                                          supportSendThis: valueOrDefault<bool>(
                                                                              currentUserDocument?.isSupportAgent,
                                                                              false),
                                                                          sendDate:
                                                                              getCurrentTimestamp,
                                                                          userRef:
