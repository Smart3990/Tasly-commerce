...
import 'order_itemdis_model.dart';
export 'order_itemdis_model.dart';

class OrderItemdisWidget extends StatefulWidget {
  const OrderItemdisWidget({
    super.key,
  ...
  @override
  State<OrderItemdisWidget> createState() => _OrderItemdisWidgetState();
}

class _OrderItemdisWidgetState extends State<OrderItemdisWidget> {
  late OrderItemdisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderItemdisModel());
                              ...
                              if (_model.removeConfirm!) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    ...
                                    backgroundColor: Color(0xFFED8254),
                                  ),
                                );
                              }
