...
class _EditProfileAuth2WidgetState extends State<EditProfileAuth2Widget> {
  ...
  void initState() {
    ...
    _model.distributorIdTextController ??= TextEditingController(
      ...
      valueOrDefault(currentUserDocument?.distibuterID, ''),
      '00000000',
    ));
        ...
        children: [
          ...
          if (valueOrDefault<bool>(currentUserDocument?.isDistributor, false))
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => TextFormField(
                  controller: _model.distributorIdTextController,
                  focusNode: _model.distributorIdFocusNode,
                  autofillHints: [AutofillHints.name],
                  textCapitalization: TextCapitalization.words,
                  obscureText: false,
                  decoration: InputDecoration(
                    ...
                    hintText: 'Enter  your distributor ID',
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primary,
                  validator: _model.distributorIdTextControllerValidator
                      .asValidator(context),
                ),
              ),
            ),
          Padding(
            ...
            child: FlutterFlowDropDown<String>(
              controller: _model.regionValueController ??=
                ...
                _model.regionValue ??= 'Greater Accra',
              ),
              options: [
                'Ahafo region',
                'Ashanti region',
              ...
              onChanged: (val) => safeSetState(() => _model.regionValue = val),
              height: 56.0,
              textStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                    letterSpacing: 0.0,
