...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // distributotRegistration
  {
    '0endig0r': {
      'en': 'Distributor Application Form',
      'ar': 'أكمل ملفك الشخصي',
      'es': 'Completa tu perfil',
      'fr': 'Complète ton profil',
    },
  ...
  // ApplicationStatus
  {
    ...
    '64yc2asq': {
      'en':
          'We have successfully received your application and will review it. You can expect feedback within 5 working days. If needed, we will reach out for further details',
      'ar': '',
      'es': '',
      'fr': '',
    },
